...
const orderSchema = new mongoose.Schema(
  {
    ...
    couponDetails: {
      value: { type: Number, default: null }, // Discount value (e.g., 20 for 20% or 10 for $10 off)
      type: { type: String, enum: ["percentage", "amount"], default: null }, // Type of discount
    },
    shippingAddress: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "ShippingAddress",
      required: true,
    }, // Reference to ShippingAddress
